...
func generate(name string, args []string) {
	...
	var (
		...
		addext      = flags.String("addext", "", "If non-empty, a regular expression describing which extensions to include in addition to those supported by the selected profile")
